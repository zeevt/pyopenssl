...
class Connection(object):
    ...
    def get_pfs_key(self):
        """
        Obtain the ephemeral key used in key exchange.

        :returns: The ephemeral key used in key exchnage
            or :py:obj:`None` is no ephemeral key exchange was used.
        :rtype: :py:class:`Crypto.PKey` or :py:class:`NoneType`
        """
        ...
        pkey._pkey = _ffi.gc(p_evp_pkey[0], _lib.EVP_PKEY_free)
        return pkey
